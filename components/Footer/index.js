...
function Footer() {
  return (
    <div className='footer'>
        <div className='name'>Developed by <a href="https://github.com/captainIN" target="_blank" rel="noreferrer" >@captainIN</a></div>
        <div className='social'>
            <a className='icon' href="https://linkedin.com/in/jaymanyoo" target="_blank" rel="noreferrer" >
            ...
            <a className='icon' href="https://github.com/captainIN" target="_blank" rel="noreferrer" >
